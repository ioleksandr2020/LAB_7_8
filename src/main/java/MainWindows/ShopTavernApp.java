...
public class ShopTavernApp extends Application {
    ...
    public void start(Stage primaryStage) {
        final Logger logger = LogManager.getLogger(ShopTavernApp.class);

        Command openBuyWindow = new OpenBuyWindowCommand(primaryStage);
        Command openSellWindow = new OpenSellWindowCommand(primaryStage);
        ...
        buyButton.setOnAction(e -> {
            ...
            openBuyWindow.execute();
        });

        sellButton.setOnAction(e -> {
            logger.info("Sell button clicked");
            openSellWindow.execute();
        });
